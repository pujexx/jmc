<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>template/js/jquery.validation.js"></script>
...
//                });
    ...
    <body>
        ...
        <?php echo form_open('login/index', "name='loginform' id='loginform'"); ?>
        <div id="login">
            <br>
            ...
            <table border="0" align="center">
                ...
                <tr>
                    <td>username</td>
                    <td><input type="text" name="username" validation="required" /></td>
                </tr>

                <tr>
                    <td>password</td>
                    <td><input type="password" name="password" validation="required"/></td>
                </tr>

                <tr>
                    <td></td>
                    <td>
                        <input type="submit" name="post" value="Login" id="loginbutton"/>
